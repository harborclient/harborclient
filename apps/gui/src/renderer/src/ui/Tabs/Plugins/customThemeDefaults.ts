...
export const LIGHT_CUSTOM_THEME_PALETTE: CustomThemePalette = {
  ...
  'sidebar-rail': '#c1d7e6',
  'sidebar-rail-active': '#a8c9e0',
  'sidebar-rail-text': 'rgba(0, 0, 0, 0.85)',
  'sidebar-rail-separator': '#a7bac7',
...
export const DARK_CUSTOM_THEME_PALETTE: CustomThemePalette = {
  ...
  'sidebar-rail': '#19344f',
  'sidebar-rail-active': '#0f1f30',
  'sidebar-rail-text': '#ffffff',
  'sidebar-rail-separator': '#3d546b',
