...
export const LIGHT_CUSTOM_THEME_PALETTE: CustomThemePalette = {
  ...
  'breadcrumb-segment': '#d8d8dc',
  'breadcrumb-current': '#c8c8ce',
  'control': '#ffffff',
  'field': '#ffffff',
  ...
  'doc-markdown': '#007aff',
  'tab-unsaved': '#b45309',
  'tab-underline': '#007aff',
  'resize-handle': '#007aff',
  'variable-token': '#007aff',
  'danger': '#ff3b30',
  'danger-light': '#d70015',
  'warning': '#ff9500',
  'success': '#34c759',
...
export const DARK_CUSTOM_THEME_PALETTE: CustomThemePalette = {
  ...
  'resize-handle': '#0a84ff',
  'variable-token': '#0a84ff',
  'danger': '#ff453a',
  'danger-light': '#ff6961',
  'warning': '#ff9f0a',
  'success': '#30d158',
