 ...
 * so Results rows match the visual language of the workflow timeline.
 *
 * @param props - Action, selection, store accessor, and open handler.
 * @returns Full-width timeline block option.
 */
export function WorkflowRunResultBlock({
  ...
  return (
    <TimelineBlock id={id} label={label} selected={selected} fillWidth onSeek={onOpen}>
