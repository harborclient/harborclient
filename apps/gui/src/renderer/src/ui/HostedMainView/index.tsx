...
interface Props {
  ...
  /**
   * Closes the hosted main view tab.
   */
  onClose: () => void;
}

/**
 * Renders one plugin-contributed main-area view inside a page tab.
 */
export function HostedMainView({ pluginId, viewId, onClose }: Props): JSX.Element | null {
