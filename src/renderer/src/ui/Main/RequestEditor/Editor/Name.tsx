      ...
      {editingName ? (
        <div className="flex w-full min-w-0 items-center gap-1">
          ...
          <Input
            ref={nameInputRef}
            variant="plain"
            className="min-w-0 flex-1 border-none bg-transparent p-0 font-semibold text-text outline-none app-no-drag"
            type="text"
            value={name}
        ...
        <div className="flex w-full min-w-0 items-center gap-1">
          ...
          <button
            type="button"
            className="flex min-w-0 flex-1 cursor-text items-center border-none bg-transparent p-0 text-left font-semibold text-text hover:opacity-80 app-no-drag"
