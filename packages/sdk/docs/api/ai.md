...
<HcMethod name="ai.copyToChat" :level="2" />

<HcMethod name="ai.instructions.add" :level="2" />

<HcMethod name="ai.onAfterTurn" :level="2" />

<HcMethod name="ai.onBeforeTurn" :level="2" />

<HcMethod name="ai.registerChatPointer" :level="2" />
