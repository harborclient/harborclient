import type { Folder, HttpMethod, SavedRequest, ScriptTestResult, ScriptExecutionEvent, SendResult } from './types';
/**
 ...
 */
export declare function summarizeRunnerResults(results: CollectionRunnerRequestResult[]): CollectionRunnerSummary;
/**
 ...
 */
export declare function resolveImportedRunnerTargetIds(data: RunResultsExport, collections: Array<{
    id: number;
    uuid: string;
}>, requestsByCollection: Record<number, Array<{
    id: number;
    uuid: string;
}>>): {
    collectionId: number;
 ...
 */
export declare function normalizeCollectionRunnerConfig(input: Partial<CollectionRunnerConfig> | null | undefined): CollectionRunnerConfig;
/**
 ...
 */
export declare function getRequestsInRunOrder(collectionId: number, folderId: number | null | undefined, requests: SavedRequest[], folders: Folder[]): SavedRequest[];
/**
 ...
 * @returns Requests ordered for sequential execution.
 */
export declare function getCollectionRunnerRequests(collectionId: number, folderId: number | null | undefined, requestId: number | null | undefined, requests: SavedRequest[], folders: Folder[]): SavedRequest[];
/**
 ...
 */
export declare function getRequestsByIds(requestIds: number[], requestsByCollection: Record<number, SavedRequest[]>): SavedRequest[];
/**
 ...
 */
export declare function isCollectionRunnerRequestFailure(response: {
    status: number;
    error?: string;
} | null | undefined, testResults: ScriptTestResult[]): boolean;
/**
 ...
 */
export declare function buildPendingCollectionRunnerResults(requests: SavedRequest[]): CollectionRunnerRequestResult[];
/**
 ...
 */
export declare function resolveCollectionRunnerNextIndex(orderedRequests: SavedRequest[], currentIndex: number, nextRequest: string | null | undefined): number | null;
