        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    url: {
                        type: 'string',
                        description: 'Request URL. When changed without params, the params table syncs from the query string.'
                    },
                    body: {
                        type: 'string',
                        description: 'Request body content. For multipart/urlencoded this is JSON-serialized structured rows; prefer body_raw when editing the Raw body drawer.'
                    },
                    body_type: {
                        type: 'string',
                    ...
                    body_raw: {
                        type: ['string', 'null'],
                        description: 'Verbatim Raw body override for multipart/urlencoded. Sets the wire text sent as-is and best-effort syncs structured rows. Pass null to clear the override.'
                    },
                    pre_request_script: {
                        type: 'string',
                    ...
                    cookies: {
                        type: 'array',
                        items: AI_KEY_VALUE_SCHEMA,
                        description: 'Cookies for the request host; stored in the cookie jar for the URL hostname.'
                    },
                    cookies_mode: {
                        type: 'string',
                        enum: ['merge', 'replace'],
...
//# sourceMappingURL=updateActiveRequest.js.map