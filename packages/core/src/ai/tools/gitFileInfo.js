...
export const gitFileInfoTool = {
    ...
    definition: {
        ...
        function: {
            name: 'git_file_info',
            description: 'Returns detailed information about one saved request in a git-backed collection, including its repository-relative file path and commit history for that file. Use get_request or list_requests to find request uuids.',
            parameters: {
                type: 'object',
                properties: {
                    collectionUuid: {
...
//# sourceMappingURL=gitFileInfo.js.map