...
export const getRequestTool = {
    ...
    definition: {
        ...
        function: {
            name: 'get_request',
            description: 'Returns one saved request by uuid with method, url, headers, params, body, auth, and scripts. Use when the user message contains @request.<uuid>. Use the uuid only for this tool call; refer to the request by its returned name in replies.',
            parameters: {
                type: 'object',
                properties: {
