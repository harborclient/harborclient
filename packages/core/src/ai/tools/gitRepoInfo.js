...
export const gitRepoInfoTool = {
    ...
    definition: {
        ...
        function: {
            name: 'git_repo_info',
            description: 'Returns git repository metadata for a git-backed collection: remote url, repo path, HarborClient data path, branch/status, saved requests and documents with repo-relative paths, and uncommitted changes. Use list_collections or get_collection to find a collection uuid.',
            parameters: {
                type: 'object',
                properties: {
                    collectionUuid: {
...
//# sourceMappingURL=gitRepoInfo.js.map