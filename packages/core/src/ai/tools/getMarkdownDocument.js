...
export const getMarkdownDocumentTool = {
    ...
    definition: {
        ...
        function: {
            name: 'get_markdown_document',
            description: 'Returns one collection markdown document or saved request comment by uuid with name and markdown content. Use when the user message contains @markdown.<uuid>. Prefer the open editor tab content when the document is being edited. Use the uuid only for this tool call; refer to the document by its returned name in replies.',
            parameters: {
                type: 'object',
                properties: {
                    uuid: {
...
//# sourceMappingURL=getMarkdownDocument.js.map