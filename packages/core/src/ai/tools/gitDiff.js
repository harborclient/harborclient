...
export const gitDiffTool = {
    ...
    definition: {
        ...
        function: {
            name: 'git_diff',
            description: 'Returns uncommitted git changes for the HarborClient subdirectory of the repository that contains a collection. Use get_collection or list_collections to find a collection uuid. The diff covers the whole repository working tree for that git connection, not only the referenced collection folder.',
            parameters: {
                type: 'object',
                properties: {
                    collectionUuid: {
