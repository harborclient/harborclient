 ...
 */
export declare const importVariables: z.ZodPipe<z.ZodDefault<z.ZodArray<z.ZodUnknown>>, z.ZodTransform<Variable[], unknown[]>>;
/**
 ...
 */
export declare function findDuplicateFolderIndex(folders: ReadonlyArray<{
    name: string;
}>): number | null;
/**
 ...
 */
export declare function findDuplicateFolderUuidIndex(folders: ReadonlyArray<{
    uuid?: string;
}>): number | null;
/**
 * Validates folder rows and applies index-based sort_order defaults.
 */
export declare const exportedFolders: z.ZodPipe<z.ZodDefault<z.ZodArray<z.ZodPipe<z.ZodObject<{
    uuid: z.ZodOptional<z.ZodString>;
    name: z.ZodString;
    sort_order: z.ZodOptional<z.ZodNumber>;
    variables: z.ZodOptional<z.ZodPipe<z.ZodDefault<z.ZodArray<z.ZodUnknown>>, z.ZodTransform<Variable[], unknown[]>>>;
    headers: z.ZodOptional<z.ZodArray<z.ZodObject<{
        key: z.ZodString;
        value: z.ZodString;
        enabled: z.ZodBoolean;
    }, z.core.$strip>>>;
    auth: z.ZodOptional<z.ZodPipe<z.ZodObject<{
        ...
        oauth2: z.ZodOptional<z.ZodObject<{
            ...
            clientAuth: z.ZodOptional<z.ZodEnum<{
                body: "body";
                header: "header";
            }>>;
        }, z.core.$strip>>;
    }, z.core.$loose>, z.ZodTransform<import("../auth").AuthConfig, {
        [x: string]: unknown;
    ...
    pre_request_scripts: z.ZodPipe<z.ZodOptional<z.ZodArray<z.ZodDiscriminatedUnion<[z.ZodObject<{
        id: z.ZodString;
        enabled: z.ZodBoolean;
    ...
    }, z.core.$strip>], "kind">>>, z.ZodTransform<import("../types").ScriptRef[] | undefined, ({
        id: string;
        enabled: boolean;
        kind: "inline";
    ...
    post_request_scripts: z.ZodPipe<z.ZodOptional<z.ZodArray<z.ZodDiscriminatedUnion<[z.ZodObject<{
        id: z.ZodString;
        enabled: z.ZodBoolean;
        kind: z.ZodLiteral<"inline">;
        name: z.ZodOptional<z.ZodString>;
    ...
    color: z.ZodPipe<z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodNull]>>, z.ZodTransform<string | null, string | null | undefined>>;
 ...
 */
export declare const exportedRequests: z.ZodPipe<z.ZodArray<z.ZodPipe<z.ZodObject<{
    uuid: z.ZodOptional<z.ZodString>;
    name: z.ZodString;
    method: z.ZodEnum<{
        GET: "GET";
    ...
    folder_name?: string | null | undefined;
    folder_uuid?: string | null | undefined;
}>>>, z.ZodTransform<ExportedRequest[], {
    uuid: string | undefined;
    name: string;
    method: "GET" | "POST" | "PUT" | "PATCH" | "DELETE" | "HEAD" | "OPTIONS";
    url: string;
 ...
 */
export declare const exportedDocuments: z.ZodPipe<z.ZodDefault<z.ZodArray<z.ZodPipe<z.ZodObject<{
    uuid: z.ZodOptional<z.ZodString>;
    name: z.ZodString;
    ...
    folder_name?: string | null | undefined;
    folder_uuid?: string | null | undefined;
}>>>>, z.ZodTransform<ExportedDocument[], {
    uuid: string | undefined;
    name: string;
    content: string;
    sort_order: number | undefined;
...
export declare const collectionExportSchema: z.ZodObject<{
    folders: z.ZodPipe<z.ZodDefault<z.ZodArray<z.ZodPipe<z.ZodObject<{
        uuid: z.ZodOptional<z.ZodString>;
        name: z.ZodString;
        sort_order: z.ZodOptional<z.ZodNumber>;
        variables: z.ZodOptional<z.ZodPipe<z.ZodDefault<z.ZodArray<z.ZodUnknown>>, z.ZodTransform<Variable[], unknown[]>>>;
    ...
    documents: z.ZodPipe<z.ZodDefault<z.ZodArray<z.ZodPipe<z.ZodObject<{
        uuid: z.ZodOptional<z.ZodString>;
        name: z.ZodString;
        content: z.ZodDefault<z.ZodString>;
        sort_order: z.ZodOptional<z.ZodNumber>;
    ...
    uuid: z.ZodOptional<z.ZodString>;
    name: z.ZodString;
    variables: z.ZodPipe<z.ZodDefault<z.ZodArray<z.ZodUnknown>>, z.ZodTransform<Variable[], unknown[]>>;
    headers: z.ZodDefault<z.ZodArray<z.ZodObject<{
        key: z.ZodString;
        value: z.ZodString;
        enabled: z.ZodBoolean;
    ...
    requests: z.ZodPipe<z.ZodArray<z.ZodPipe<z.ZodObject<{
        uuid: z.ZodOptional<z.ZodString>;
        name: z.ZodString;
        method: z.ZodEnum<{
            GET: "GET";
 ...
 */
export declare const requestExportSchema: z.ZodPipe<z.ZodObject<{
    harborclientVersion: z.ZodLiteral<1>;
