 ...
 */
export declare const authConfig: z.ZodPipe<z.ZodObject<{
...
}, z.core.$loose>, z.ZodTransform<AuthConfig, {
    [x: string]: unknown;
 ...
 */
export declare const exportScriptRefArray: z.ZodPipe<z.ZodOptional<z.ZodArray<z.ZodDiscriminatedUnion<[z.ZodObject<{
    id: z.ZodString;
    enabled: z.ZodBoolean;
...
}, z.core.$strip>], "kind">>>, z.ZodTransform<ScriptRef[] | undefined, ({
    id: string;
    enabled: boolean;
    kind: "inline";
