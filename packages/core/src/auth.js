...
export function normalizeAuth(value) {
  ...
  const type =
    ...
    record.type === 'none'
      ? record.type
      : fallback.type;
  const basicRecord = record.basic != null && typeof record.basic === 'object' ? record.basic : {};
  const bearerRecord =
    record.bearer != null && typeof record.bearer === 'object' ? record.bearer : {};
  const oauth2Record =
    record.oauth2 != null && typeof record.oauth2 === 'object' ? record.oauth2 : {};
  return {
    type,
    basic: {
