...
import type { ActiveTheme, AppMenu, ContextMenuTarget, ThemeColorToken } from '@harborclient/sdk';
 ...
 */
export declare function pluginSettingsSectionId(pluginId: string, sectionId: string): string;
/**
 ...
 */
export declare function pluginContributionId(pluginId: string, contributionId: string): string;
/**
 ...
 */
export declare function formatPluginThemeValue(pluginId: string, themeId: string): string;
/**
 ...
 */
export declare function toActiveTheme(theme: ThemeSource): ActiveTheme;
/**
 ...
 */
export declare function activeThemeKey(theme: ActiveTheme): string;
