...
export const BUILTIN_ACTIONS: ActionCommandDefinition[] = [
  ...
  { id: 'builtin:reset-zoom', group: 'View', label: 'Reset Zoom' },
  { id: 'builtin:theme-light', group: 'View', label: 'Light' },
  { id: 'builtin:theme-dark', group: 'View', label: 'Dark' },
  { id: 'builtin:theme-high-contrast', group: 'View', label: 'High contrast' },
  { id: 'builtin:theme-system', group: 'View', label: 'System' },
  {
  ...
  { id: 'builtin:git-fetch', group: 'Git', label: 'Fetch' },
  { id: 'builtin:git-pull', group: 'Git', label: 'Pull' },
  { id: 'builtin:git-push', group: 'Git', label: 'Push' },
