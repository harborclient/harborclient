 ...
 */
export declare function scriptEventNameFromPhase(phase: ScriptPhase): ScriptRunInfo['eventName'];
/**
 ...
 */
export declare function buildScriptRunInfo(phase: ScriptPhase, options?: {
    requestName?: string;
 ...
 */
export type ScriptExecutionVariableScope = 'request' | 'collection' | 'folder' | 'environment' | 'global';
/**
