 ...
 */
export declare const tabGroupExportSchema: z.ZodObject<
  {
    harborclientVersion: z.ZodLiteral<1>;
    harborclientExport: z.ZodLiteral<'tab_group'>;
    name: z.ZodString;
    requestUuids: z.ZodArray<z.ZodString>;
 ...
 */
export declare function validateTabGroupExport(data: unknown): TabGroupExport;
