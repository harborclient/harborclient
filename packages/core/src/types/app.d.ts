 ...
 */
export type MenuActionId = 'new-request' | 'new-collection' | 'new-environment' | 'import' | 'save' | 'settings' | 'plugins' | 'themes' | 'snippets' | 'cookies' | 'team-hubs' | 'accept-team-hub-invite' | 'sharing-keys' | 'join-shared-collection' | 'sync' | 'toggle-sidebar' | 'focus-sidebar-search' | 'focus-request-url' | 'focus-first-collection' | 'focus-first-environment' | 'focus-first-request-tab' | 'focus-response-editor' | 'focus-main-nav' | 'toggle-variables' | 'toggle-console' | 'toggle-ai-sidebar' | 'toggle-git-sidebar' | 'toggle-request-editor' | 'toggle-response-editor' | 'toggle-collections-section' | 'toggle-environments-section' | 'toggle-run-results-section' | 'send-request' | 'previous-request-tab' | 'next-request-tab' | 'set-method-get' | 'set-method-post' | 'set-method-put' | 'set-method-patch' | 'set-method-delete' | 'set-method-head' | 'set-method-options' | 'getting-started' | 'documentation' | 'report-issue' | 'about' | 'check-for-updates' | 'shortcuts-reference' | 'action-menu' | 'undo' | 'redo' | 'create-tab-group' | 'deselect-all-sidebar' | 'format-markdown-document' | 'new-collection-git' | 'git-create-branch' | 'git-delete-branch' | 'git-commit' | 'git-merge' | 'git-fetch' | 'git-pull' | 'git-push' | 'git-settings';
/**
