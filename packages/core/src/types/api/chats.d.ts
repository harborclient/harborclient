import type { AddChatMessageInput, Chat, ChatMessage, ChatStepInput, ChatStepResult, ChatSummary, CreateChatInput, GenerateChatTitleInput, GithubModelsSignInFinishedEvent, GithubModelsStatus, HubLlmModelGroup } from '../ai';
/**
...
export interface ApiChats {
     ...
     */
    startGithubModelsSignIn: () => Promise<{
        userCode: string;
     ...
     */
    onGithubModelsSignInFinished: (callback: (event: GithubModelsSignInFinishedEvent) => void) => () => void;
    /**
