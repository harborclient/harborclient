import type { HarborDeepLink } from '../../deepLink';
import type { MenuSelectThemePayload, ThemeMenuOption } from '../../themes';
import type { MenuActionId, AppSubmenuItemSnapshot, RootMenuLabel, UpdateCheckResult, BuiltinCollectionOpenRequestTarget } from '../app';
...
export interface ApiWindow {
     ...
     */
    setMenuGitCollectionActive: (active: boolean) => Promise<void>;
    /**
