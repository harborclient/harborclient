import type { McpClientServer, McpClientServerListItem, McpClientServerStatus, McpClientToolInfo, McpServerSettings, McpServerStatus } from '../mcp';
/**
...
export interface ApiMcp {
     ...
     */
    onMcpServerToolInvoke: (callback: (message: {
        requestId: number;
        name: string;
        args: unknown;
    }) => void) => () => void;
