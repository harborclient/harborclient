...
import type { CollectionRunnerConfig } from '../../collectionRunner';
import type { ShortcutBinding, ShortcutOverrides } from '../../shortcuts';
import type { AiChatSessionState, AiSettings, EditorTab, GeneralSettings, PanelLayoutState, SidebarExpansionState } from '../settings';
/**
...
export interface ApiSettings {
     ...
     */
    oauthFetchToken: (cacheKey: string, config: AuthConfig['oauth2'], force: boolean) => Promise<OAuthFetchTokenResult>;
    /**
