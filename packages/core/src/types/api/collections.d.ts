...
import type { RunResultsExport, SavedRunResult, SavedRunResultSummary, SaveRunResultInput } from '../../collectionRunner';
import type { Collection, CollectionExportResult, Folder, ImportEntityResult, ListCollectionsResult } from '../collection';
import type { RequestExport } from '../request';
...
export interface ApiCollections {
     ...
     */
    importEntity: (activeCollectionId: number | null, pluginExtensions?: string[]) => Promise<ImportEntityResult | null>;
    /**
