...
import type { SnippetBundleExport } from '../snippet';
import type { SnippetScope } from '../../snippetScope';
import type { ScriptStage } from '@harborclient/sdk';
import type { SnippetCatalog } from '../../snippet/catalog';
import type { InstalledSnippetPackage, SnippetGitPreview } from '../../snippet/types';
/**
...
export interface ApiSnippets {
     ...
     */
    createSnippet: (name: string, code: string, scope: SnippetScope, stage?: ScriptStage, connectionId?: string) => Promise<Snippet>;
    /**
