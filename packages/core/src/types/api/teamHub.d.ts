import type { AdminEntityConfig, CreateHubTokenInput, CreateHubUserInput, CreateInvitedHubUserInput, CreateUserInvitationInput, CreatedHubToken, CreatedHubUser, CreatedInvitedHubUser, HubApiTokenRecord, HubInvitationPreview, HubInvitationRecord, HubUserRecord, ReloadConfigResponse, TeamHub, TeamHubAdminCollectionContents, TeamHubAdminResourceOptions, TeamHubAdminSnippet, TeamHubAdminSnippetInput, TeamHubAdminRunResult, TeamHubInvitationRedeemResult, TeamHubSessionScanResult, TeamHubVerifiedSession, UpdateHubUserInput } from '../teamHub';
/**
...
export interface ApiTeamHub {
     ...
     */
    updateTeamHubUser: (hubId: string, userId: string, input: UpdateHubUserInput) => Promise<HubUserRecord>;
    /**
     ...
     */
    createTeamHubInvitedUser: (hubId: string, input: CreateInvitedHubUserInput) => Promise<CreatedInvitedHubUser>;
    /**
     ...
     */
    createTeamHubUserInvitation: (hubId: string, userId: string, input?: CreateUserInvitationInput) => Promise<CreatedInvitedHubUser>;
    /**
     ...
     */
    redeemTeamHubInvitation: (baseUrl: string, code: string, tokenName?: string) => Promise<TeamHubInvitationRedeemResult>;
    /**
     ...
     */
    createTeamHubUserToken: (hubId: string, userId: string, input: CreateHubTokenInput) => Promise<CreatedHubToken>;
    /**
     ...
     */
    listTeamHubAdminCollectionContents: (hubId: string, collectionId: string) => Promise<TeamHubAdminCollectionContents>;
    /**
     ...
     */
    createTeamHubAdminSnippet: (hubId: string, input: TeamHubAdminSnippetInput) => Promise<TeamHubAdminSnippet>;
    /**
     ...
     */
    updateTeamHubAdminSnippet: (hubId: string, snippetId: string, input: TeamHubAdminSnippetInput) => Promise<TeamHubAdminSnippet>;
    /**
     ...
     */
    updateTeamHubCollectionDeletionLocked: (hubId: string, collectionId: string, deletionLocked: boolean) => Promise<AdminEntityConfig>;
    /**
     ...
     */
    updateTeamHubEnvironmentDeletionLocked: (hubId: string, environmentId: string, deletionLocked: boolean) => Promise<AdminEntityConfig>;
    /**
...
//# sourceMappingURL=teamHub.d.ts.map