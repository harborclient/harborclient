import type { DiscoveredCollection, RegisterDiscoveredCollectionsResult, StorageConnection } from '../storage';
/**
...
export interface ApiStorage {
     ...
     */
    registerDiscoveredCollections: (connectionId: string, providerCollectionIds: number[]) => Promise<RegisterDiscoveredCollectionsResult>;
    /**
