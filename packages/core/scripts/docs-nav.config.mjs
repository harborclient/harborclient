...
export const docsNav = [
  ...
  { kind: 'page', slug: "imports-and-exports", title: "Imports and exports" },
  { kind: 'page', slug: "request-runner", title: "Request runner" },
  { kind: 'page', slug: "scripting", title: "Scripting" },
  { kind: 'page', slug: "types-and-ipc-contract", title: "Types and IPC contract" },
