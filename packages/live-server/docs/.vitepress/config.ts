...
const siteBase = '/harborclient/live-server/';
...
export default defineConfig({
  title: '@harborclient/live-server',
  description: 'Headless live-server host for HarborClient (Express static server, scripts, run command).',
  base: siteBase,
  ...
  themeConfig: {
    ...
    nav: [
      {
        text: `v${pkg.version}`,
        link: 'https://github.com/harborclient/harborclient/releases?q=live-server-v'
      }
    ],
    socialLinks: [
      {
