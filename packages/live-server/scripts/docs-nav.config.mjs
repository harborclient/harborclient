 ...
 *
 * Edit to reorder nav or add pages. Run `pnpm docs:build:nav` to regenerate
 * the sidebar.
 */
...
export const docsNav = [
  ...
  { kind: 'page', slug: 'installation', title: 'Installation' },
  { kind: 'page', slug: 'usage', title: 'Usage' },
  { kind: 'page', slug: 'host-api', title: 'Host API' },
